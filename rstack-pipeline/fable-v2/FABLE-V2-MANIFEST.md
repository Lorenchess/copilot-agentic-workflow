...
Every file below was written new into `rstack-pipeline/fable-v2/`. No existing file anywhere was modified; nothing was staged or committed; no script was created.

**Baselines.** "Proposed" = the ChatGPT file (`*.proposed-simplified.md` / `*.proposed-improved.md`), the editing baseline. "Original" = the screenshot reconstruction (`*.original-from-screenshots.md`), read to find guarantees the proposal dropped; for the planner only its operative part (lines 1–296, not the OCR appendix). **Astra findings** cite `RSTACK-V2-ARCHITECTURE-REVIEW.md` §3 (C-numbers), `RSTACK-V2-DECISIONS.md` (ADR-numbers) and the fifteen numbered findings of the editing brief (#n).
...
- **Astra findings:** #2, #3, #8, #14; C6, C8, C9.
...
- **Astra findings:** #4, #5, #6, #7, #9, #15; C6.
...
- **Astra findings:** #4, #5, #6; C6, C7, C11; ADR-04, ADR-09.
...
- **Astra findings:** #1, #2, #4, #5, #8, #13; C6, C7; ADR-04, ADR-06.
...
- **Baseline:** proposed (15,427) → 13,866. **Astra:** #1, #5, #6, #14; "HEAD/committed AC cycle unresolved".
...
- **Baseline:** proposed-improved (8,810) → 7,944. **Astra:** #6, #7, #9.
...
- **Baseline:** proposed (8,426) → 9,302. **Astra:** #6, #7; ADR-05, ADR-09.
...
- **Baseline:** proposed (6,642) → 4,841. **Astra:** #11; C10; ADR-07 (A-class — not imported).
...
- **Baseline:** proposed (4,419) → 3,233. **Astra:** #1, #7, C12.
...
- **Baseline:** proposed (4,276) → 4,308. **Astra:** #7, #1; C1.
...
- **Baseline:** proposed (5,402) → 4,128. **Astra:** C12, #7.
...
- **Baseline:** proposed (5,234) → 3,212. **Astra:** #12; ADR-12.
...
- **Baseline:** proposed (3,454) → 3,442. **Astra:** #13; ADR-11.
...
- **Baseline:** proposed (2,790) → 3,204. **Astra:** C12, #6.
...
- **Baseline:** proposed-improved (4,945) → 4,618. **Astra:** #11, #15.
...
- **Baseline:** proposed (5,303) → 4,471. **Astra:** #14; C9; ADR-13.
...
`FABLE-V2-MANIFEST.md` (this file) · `FABLE-V2-CHANGELOG.md` · `FABLE-V2-RULE-OWNERSHIP.md` · `FABLE-V2-OPEN-DECISIONS.md`.
