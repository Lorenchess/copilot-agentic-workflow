...
Then return `PLAN_READY` in the structured result envelope (`handoff-contracts.md`); if you cannot complete, return `NEEDS_HUMAN` naming the decision, or `STOPPED` with the owned blocker.
