...
**Never** the plan auditor or the reviewer-architect. Their value is that they inherit no earlier conclusion. The orchestrator does not send it to them. If it reaches one anyway, that role reports contamination and a new invocation is dispatched; ignoring text does not erase exposure.
