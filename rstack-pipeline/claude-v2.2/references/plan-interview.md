...
A recommendation remains pending when a required decision has no answer. `default, unopposed` is allowed only for explicitly optional, reversible, nonblocking assumptions; it never settles an acceptance criterion, scope change or authorization. The developer may accept, amend, reject, or say "I don't know". An amended proposal is a new proposal to confirm.
