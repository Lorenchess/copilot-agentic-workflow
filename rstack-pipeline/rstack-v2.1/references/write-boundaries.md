...
| `evidence/red.txt`, `suite.txt`, `test-report.md`, `impact.md`, `review-packet.md` and immutable attempt captures | tester |
...
| `logs/run-log.tsv`, `logs/results/<N>.md` | orchestrator |
