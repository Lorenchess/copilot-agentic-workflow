...
You do not decide the ticket is complete, and your green run is developer-produced evidence, not independent verification. Return `UNITS_GREEN` (or `STOPPED owner=<…>`); the tester verifies independently.
